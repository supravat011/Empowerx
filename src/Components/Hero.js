    ...
    return(
        <div className="relative">
            ...
            <div className="relative bg-opacity-75 backgroundMain">
                ...
                md:max- -full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
                    <div className="flex flex-col items-center justify-between xl:flex-row">
                        <div className="w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12">
                            ...
                            <a href="https://en.wikipedia.org/wiki/Crowdfunding"
                                ...
                                viewBox="0 0 12 12"
                                >
                                    <path d="M9.707,5.293L-5-5A1,1,0,0,03.293,1.707L7.586,6,3.293,10.
                                    293a1,1,1,0,1.414,1.414l5-5A1,1,0,0,0,9.707,5.293Z"/>
                                </svg>
                            </a>
                        </div>
