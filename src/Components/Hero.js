                    ...
                    <div className="flex flex-col items-center justify-between xl:flex-row">
                        <div className="w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12">
                            ...
                            <p className="max-w-xl mb-4 text-base text-gray-200 md:text-lg">
                                Send your Crypto to Public or Requested Campaigns
                            </p>
                            <a href="https://en.wikipedia.org/wiki/Crowdfunding"
                                aria-label=""
                                className="inline-flex items-center font-semibold tracking-wider transition-colors duration-200 text-teal-accent-400 hover:text-teal-accent-700 text-blue-200"
                            >
                                Learn More
                                <svg className="inline-block w-3 ml-2" fill="currentColor" viewBox="0 0 12 12">
                                    <path d="M9.707 5.293L4.707 0.293A1 1 0 0 0 3.293 1.707L7.586 6 3.293 10.293A1 1 0 0 0 4.707 11.707L9.707 6.707A1 1 0 0 0 9.707 5.293Z"/>
                                </svg>
                            </a>
                        </div>
